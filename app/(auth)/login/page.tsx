...
import { CornerUpRightIcon, Leaf, Lock } from "lucide-react";
        ...
        <div className="w-full max-w-md wooden-texture rounded-xl shadow-[0_20px_50px_rgba(0,0,0,0.5)] p-8 flex flex-col gap-6 relative border-t-8 border-b-8 z-10 animate-fade-in-up" style={{ animationDelay: '0.1s', opacity: 0 }}>
          ...
          <div className="absolute -top-6 left-1/2 -translate-x-1/2 bg-primary px-6 py-2 rounded-full shadow-lg border-2 border-wood-dark">
            <div className="flex items-center gap-2">
              <span className="size-6 text-wood-dark"><img src={'/banana.svg'} /></span>
          ...
          <form className="flex flex-col gap-5">
            <div className="flex flex-col gap-2">
              <label className="text-stone-200 text-sm font-bold flex items-center gap-2">
                EXPLORER NAME
              </label>
              <div className="relative">
                <input
                  ...
                  placeholder="Hollowed-out bamboo ID"
                  type="text"
                />
            ...
            <button
              className="w-full bg-primary hover:bg-yellow-400 text-wood-dark font-black text-lg py-4 rounded-full shadow-[0_6px_0_0_var(--color-shadow-yellow)] active:shadow-none active:translate-y-1 transition-all flex items-center justify-center gap-3 mt-2"
              type="submit"
            >
              START THE ADVENTURE
              <CornerUpRightIcon />
          ...
          <button className="w-full bg-[#FDE047] hover:bg-yellow-300 text-stone-900 font-bold py-4 px-6 rounded-[2rem_5rem_2rem_5rem] shadow-lg flex items-center justify-center gap-3 border-b-4 border-yellow-600 transition-transform hover:scale-[1.02]">
